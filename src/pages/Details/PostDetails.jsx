...
const PostDetails = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto bg-white dark:bg-base-200 p-8 rounded-2xl shadow-lg mt-10 border border-gray-200">
            <h2 className="text-4xl font-bold text-left mb-8 text-primary">{post.title}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 text-base-content mb-3">
                ...
                <div className="space-y-4">
                    ...
                    <p className="flex items-center gap-2">
                        ...
                        <span className="font-semibold"></span> {post.userEmail}
                    </p>
                    <p className="flex items-center gap-2">
            ...
            <div className='flex gap-2 items-center'>
                ...
                <div className="mt-10 text-center">
                    <button onClick={handleLike} className="btn btn-success text-white text-lg px-8 py-2 flex items-center gap-2">
